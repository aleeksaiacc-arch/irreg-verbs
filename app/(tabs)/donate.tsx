        ...
        >
          <View style={[styles.heroWrap, { backgroundColor: accentGlow }]}>
            <View
              style={[
                styles.iconRing,
                {
                  borderColor: isDark ? "rgba(255,255,255,0.12)" : "rgba(10,126,164,0.2)",
                },
              ]}
            >
            ...
            <ThemedText style={[styles.heroLead, { color: textMuted }]}>
              If this app helps you learn, you can chip in to keep it improving—new
              features, polish, and reliable sync for everyone.
            </ThemedText>
          </View>
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={[styles.paragraph, { color: textMuted }]}>
              Building and maintaining a focused learning tool takes time. Your support
              helps cover infrastructure, design, and the slow work of making drills
              feel effortless on every device.
            </ThemedText>
            <ThemedText style={[styles.paragraph, { color: textMuted }]}>
              There is no obligation—use the app as long as you like. A donation is
              simply a thank-you if you want to give back.
            </ThemedText>
          </View>
